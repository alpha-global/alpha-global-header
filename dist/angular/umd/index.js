...
// CONCATENATED MODULE: ./src/util/menu-width.ts
...
var alpha_global_header_component_MenuItem = /** @class */ (function () {
    function MenuItem() {
    }
    MenuItem = __decorate([
        Object(core__["Directive"])({ selector: 'li' })
    ], MenuItem);
    return MenuItem;
}());

var alpha_global_header_component_SubMenu = /** @class */ (function () {
    function SubMenu() {
    }
    SubMenu = __decorate([
        Object(core__["Directive"])({ selector: 'ul' })
    ], SubMenu);
    return SubMenu;
}());
...
var alpha_global_header_component_AlphaGlobalHeader = /** @class */ (function () {
    ...
    __decorate([
        Object(core__["ContentChildren"])(alpha_global_header_component_MenuItem, { descendants: false, read: core__["ElementRef"] }),
        __metadata("design:type", core__["QueryList"])
    ], AlphaGlobalHeader.prototype, "menuItems", void 0);
    __decorate([
        Object(core__["ContentChildren"])(alpha_global_header_component_SubMenu, { descendants: true, read: core__["ElementRef"] }),
        __metadata("design:type", core__["QueryList"])
    ], AlphaGlobalHeader.prototype, "subMenus", void 0);
    __decorate([
        Object(core__["ViewChild"])('mainMenu'),
        __metadata("design:type", core__["ElementRef"])
    ], AlphaGlobalHeader.prototype, "mainMenu", void 0);
    __decorate([
    ...
    __decorate([
        Object(core__["Input"])('searchAction'),
    ...
    ], AlphaGlobalHeader.prototype, "onMenuClick", null);
    __decorate([
        Object(core__["HostBinding"])('class.open'),
        __metadata("design:type", Boolean),
        __metadata("design:paramtypes", [])
    ], AlphaGlobalHeader.prototype, "opened", null);
    ...
    AlphaGlobalHeaderModule = module___decorate([
        Object(core__["NgModule"])({
            declarations: [
                ...
                alpha_global_header_component_MenuItem,
                alpha_global_header_component_SubMenu
            ],
            exports: [
                alpha_global_header_component_AlphaGlobalHeader,
                alpha_global_header_component_MenuItem,
